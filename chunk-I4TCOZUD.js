...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=G);var a="pbrFragmentExtraDeclaration",y=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=y);var r="samplerFragmentAlternateDeclaration",V=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=V);var o="pbrFragmentSamplersDeclaration",H=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=H);var t="subSurfaceScatteringFunctions",x=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=x);var f="pbrHelperFunctions",W=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=W);var c="pbrDirectLightingSetupFunctions",X=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=X);var l="pbrDirectLightingFalloffFunctions",k=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=k);var d="pbrDirectLightingFunctions",Y=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=Y);var s="pbrIBLFunctions",w=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=w);var E="pbrBlockAlbedoOpacity",z=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=z);var R="pbrBlockReflectivity",K=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=K);var C="pbrBlockAmbientOcclusion",q=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=q);var m="pbrBlockAlphaFresnel",Z=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Z);var S="pbrBlockAnisotropic",J=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=J);var A="pbrBlockReflection",j=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var u="pbrBlockSheen",Q=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=Q);var I="pbrBlockClearcoat",$=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=$);var v="pbrBlockIridescence",ee=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=ee);var p="pbrBlockSubSurface",ie=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ie);var O="pbrBlockNormalGeometric",ne=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ne);var N="pbrBlockNormalFinal",ae=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=ae);var T="pbrBlockLightmapInit",re=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);var L="pbrBlockGeometryInfo",oe=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=te);var D="pbrBlockReflectance",fe=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=fe);var M="pbrBlockDirectLighting",ce=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ce);var _="pbrBlockFinalLitComponents",le=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=le);var h="pbrBlockFinalUnlitComponents",de=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=de);var F="pbrBlockFinalColorComposition",se=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=se);var P="pbrBlockImageProcessing",Ee=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Ee);var U="pbrBlockPrePass",Re=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Re);var b="pbrDebug",Ce=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ce);var i="pbrPixelShader",B=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=B);var Hn={name:i,shader:B};export{Hn as a};
