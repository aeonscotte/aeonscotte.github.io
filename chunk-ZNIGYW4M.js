import{a as e}from"./chunk-L3UYHT7M.js";var s="gaussianSplattingVertexDeclaration",i="attribute vec2 position;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=i);var o="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
attribute vec2 position;`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=c);var a="gaussianSplatting",n=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*pos2d.w)*scale,pos2d.zw);}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=n);var t="gaussianSplattingVertexShader",r=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[t]||(e.ShadersStore[t]=r);var V={name:t,shader:r};export{V as a};
